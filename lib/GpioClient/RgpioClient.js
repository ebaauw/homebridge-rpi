  ...
  */
  ...
  ntfDecode (data) {
    ...
    if (payload.level === 2) {
      ...
      this.values[payload.gpio] = payload.level
    }
  ...
  async setWatchDog (gpio, timeout) {
    await this.command(this.commands.GWDOG, { longs: [this.gpioChipHandle, gpio, timeout * 1000] })
  }
