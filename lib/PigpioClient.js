...
// Delay execution for number of milliseconds.
...
class PigpioClient extends events.EventEmitter {
  ...
  async command (cmd, p1 = 0, p2 = 0, p3 = Buffer.from('')) {
    ...
    /** Emitted when a command is sent to to pigpio.
    ...
    this._cmd = null
    /** Emitted when a command response is received from pigpio.
      * @event PigpioClient#response
      * @param {string} command - The command name.
      * @param {int|string} response - The response.
      */
