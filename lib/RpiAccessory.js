...
class RpiAccessory extends AccessoryDelegate {
  static DS18B20_SENSOR_ID_PATTERN = /^28-[0-9a-fA-F]{12}$/
        ...
        if (this.usesW1) {
          ...
          try {
            ...
            for (const sensorId of localW1Devices) {
              if (typeof sensorId === 'string' && RpiAccessory.DS18B20_SENSOR_ID_PATTERN.test(sensorId)) {
  ...
  async addDs18b20 (device) {
    ...
    if (typeof device.sensorId !== 'string' || !RpiAccessory.DS18B20_SENSOR_ID_PATTERN.test(device.sensorId)) {
