...
class RpiAccessory extends homebridgeLib.AccessoryDelegate {
  ...
  constructor (platform, params) {
    ...
    if (!this.hidden) {
      ...
      this.historyService = new homebridgeLib.ServiceDelegate.History.Sensor(
        this, {
  ...
  async addContact (device) {
    ...
    gpioAccessory.historyService = new homebridgeLib.ServiceDelegate.History.Sensor(
      gpioAccessory, {
  ...
  async addLight (device) {
    ...
    gpioAccessory.historyService = new homebridgeLib.ServiceDelegate.History.Light(
      gpioAccessory, {
        onDelegate: gpioAccessory.service.characteristicDelegate('on'),
        lastActivationDelegate: gpioAccessory.service.characteristicDelegate('lastActivation')
      }
    )
    setImmediate(() => { gpioAccessory.emit('initialised') })
  }
